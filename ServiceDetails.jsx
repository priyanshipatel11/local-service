...
export const ServiceDetails = () => {
    ...
    const submitBooking = async () => {
        try {
            const id1 = id;
            const serviceprovider = services.serviceprovider;
            ...
            const res = await axios.post("http://localhost:4000/booking/booking/", obj);
            console.log(res.data.data);
    ...
    return (
        <>
            ...
            <main class="main-content border-radius-lg " style={{ marginLeft: `27%`, objectFit: 'cover',height:`712px` }}>
                                    ...
                                    <div className="row mt-4">
                                        ...
                                        <div className="col-lg-7" >
                                            <div className="card z-index-2">
                                                ...
                                                <div className="card-body p-0" style={{ marginLeft: `160px` }}>
